                ...
                <form action="{{ route('productos.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" id="descripcion" rows="4" 
                            class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-amarillo-fuerte focus:border-transparent transition-all">{{ old('descripcion') }}</textarea>
